...
private LJListView listView = null;
	...
	private String httpUrl = "http://music.163.com/#/discover/playlist/?order=hot&cat=%E5%85%A8%E9%83%A8&limit=35&offset=0";
	...
	private boolean hasNextCategory = false;
	...
	*/
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		adapter = new MusicCategoryAdapter(getActivity(), mediaList);
		...
		hasNextCategory = getIntent().getBooleanExtra("hasNextCategory", false);*/
		
		setCenterString("歌曲榜单");
	...
	*/
	...
	{
		//httpUrl = "http://yinyue.kuwo.cn/yy/category.htm";
		// TODO Auto-generated method stub
		super.onResume();
	}
	...
	{
		/*doc.getElementById("iframe");
		doc.getElementsByClass("iframe");*/
		...
		/*Elements rootes = doc.getElementsByClass("iframe");
		if(rootes.size() == 0)
		{
			return;
		}
	...
	*/
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3)
	{
		...
		if(hasNextCategory)
		{
	    	...
	    	ViewUtils.startActivity(getActivity(), KuwoSecondCategoryActivity.class, bundle);
		}
		else
		{
			Bundle bundle = new Bundle();
