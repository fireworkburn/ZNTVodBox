...
import com.znt.diange.view.SongBookAdapter;
...
public class SongBookActivity extends BaseActivity implements IXListViewListener, OnItemClickListener
{
	...
	*/
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		adapter = new SongBookAdapter(this, mediaList, deviceInfor);
	...
	*/
	...
	public void onRefresh() 
	{
		...
		if(isRunning)
			return;
		httpFactory.getSpeakerMusic(deviceInfor.getCode());
	}
