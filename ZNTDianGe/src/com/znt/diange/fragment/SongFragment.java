...
import com.znt.diange.activity.SongInforActivity;
import com.znt.diange.dialog.PlayListDialog;
...
import com.znt.diange.utils.ImageChangeManager;
import com.znt.diange.utils.ViewUtils;
import com.znt.diange.view.CircleImageView;
import com.znt.diange.view.MarqueeTextView;
import com.znt.diange.view.SongAdapter;
import com.znt.diange.view.pulltozoom.view.PullToZoomBase.OnPullZoomListener;
import com.znt.diange.view.pulltozoom.view.PullToZoomListViewEx;
import com.znt.diange.view.pulltozoom.view.PullToZoomListViewEx.OnListScrollListener;
...
public class SongFragment extends BaseFragment implements OnPullZoomListener, OnListScrollListener, OnClickListener
{
	...
	private ImageChangeManager imageChangeManager = null;
	...
	private Handler handler = new Handler(new Callback()
	{
		...
		public boolean handleMessage(Message msg)
		{
			...
			else if(msg.what == GET_MUSIC_IMAGE_SUCCESS)
			{
				...
				imageChangeManager.setImageList(musicImgList);
				//showDefaultAlbum(false);
			}
	...
	*/
			...
			Bundle savedInstanceState)
	{
		...
		if(parentView == null) 
		{
			...
			imageChangeManager = new ImageChangeManager(getActivity(), civAlbum);
	...
	*/
	...
	public void onResume()
	{
		...
		startAlbumAnim();
		imageChangeManager.startChange();
	...
	public void onClick(View v)
	{
		...
		else if(v == tvDianbo)
		{
			if(isReconnect)
				...
				((MainActivity)getActivity()).loadMusicLibraryPage();
		}
