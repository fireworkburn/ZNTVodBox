...
import com.znt.diange.dialog.SongBookOperationDialog;
...
public class SongBookAdapter extends BaseAdapter
{
	...
	public SongBookAdapter(BaseActivity baseActivity, List<MediaInfor> mediaList, DeviceInfor deviceInfor)
	{
	...
	*/
	...
	private void showOperationDialog(final MediaInfor infor)
	{
		...
		final MusicOperationDialog dialog = new MusicOperationDialog(activity, infor, deviceInfor);
		//playDialog.updateProgress("00:02:18 / 00:05:12");
		dialog.setSpeakerMusic(true);
		if(dialog.isShowing())
			dialog.dismiss();
