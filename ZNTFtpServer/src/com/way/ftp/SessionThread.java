...
import com.way.app.FtpServerApp;
...
public class SessionThread extends Thread {
    ...
    protected File workingDir = new File(Defaults.chrootDir);
        ...
        try {
            ...
            while (true) {
                ...
                if (line != null) 
                {
                	...
                	{
                		String name1 = new String(line.getBytes("GBK"),"iso-8859-1");
                		String name2 = new String(line.getBytes("GBK"),"gb2312");
                		String name3 = new String(line.getBytes("GBK"),"utf-8");
                		//String name4 = new String(line.getBytes("GBK"),"iso-8859-1");
                		Log.e("", "收到文件名字-->" + line);
                	}*/
