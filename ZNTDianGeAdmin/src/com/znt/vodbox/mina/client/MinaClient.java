...
package com.znt.vodbox.mina.client; 
...
import com.znt.vodbox.mina.coder.MinaCoderFactory;
    ...
    private void connect()
    {
    	try
		{
            ...
            else 
            {
                ...
                Constant.deviceInfor = LocalDataEntity.newInstance(activity).getDeviceInfor();
