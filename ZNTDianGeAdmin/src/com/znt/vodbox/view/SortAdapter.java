...
public class SortAdapter extends BaseAdapter
{
	...
	public View getView(final int position, View view, ViewGroup arg2) 
	{
		...
		if (view == null) 
		{
			...
			view = LayoutInflater.from(mContext).inflate(R.layout.view_sort_item, null);
			viewHolder.tvName = (TextView) view.findViewById(R.id.tv_sort_name);
			viewHolder.tvArtist = (TextView) view.findViewById(R.id.tv_sort_artist);
			viewHolder.ivIcon = (ImageView) view.findViewById(R.id.iv_sort_icon);
			viewHolder.viewOperation = view.findViewById(R.id.view_sort_operation);
