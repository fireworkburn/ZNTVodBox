...
import com.znt.vodbox.utils.MySharedPreference;
...
public class LocalDataEntity 
{
	...
	private final String PC_CODE = "PC_CODE";
	...
	/***********账户相关***********/
	private final String USER_NAME_1 = "USER_NAME_1";
	private final String USER_NAME_2 = "USER_NAME_2";
	private final String USER_NAME_3 = "USER_NAME_3";
	
	private final String USER_PWD_1 = "USER_PWD_1";
	private final String USER_PWD_2 = "USER_PWD_2";
	private final String USER_PWD_3 = "USER_PWD_3";
	
	private final String USER_ACCOUNT_1 = "USER_ACCOUNT_1";
	private final String USER_ACCOUNT_2 = "USER_ACCOUNT_2";
	private final String USER_ACCOUNT_3 = "USER_ACCOUNT_3";
	
	private final String LON1 = "LON1";
	private final String LON2 = "LON2";
	private final String LON3 = "LON3";
	
	private final String LAT1 = "LAT1";
	private final String LAT2 = "LAT2";
	private final String LAT3 = "LAT3";
	
	public void setUser1(UserInfor userInfor)
	{
		sharedPre.setData(USER_NAME_1, userInfor.getUserName());
		sharedPre.setData(USER_PWD_1, userInfor.getPwd());
		sharedPre.setData(USER_ACCOUNT_1, userInfor.getAccount());
	}
	public void setUser2(UserInfor userInfor)
	{
		sharedPre.setData(USER_NAME_2, userInfor.getUserName());
		sharedPre.setData(USER_PWD_2, userInfor.getPwd());
		sharedPre.setData(USER_ACCOUNT_2, userInfor.getAccount());
	}
	public void setUser3(UserInfor userInfor)
	{
		sharedPre.setData(USER_NAME_3, userInfor.getUserName());
		sharedPre.setData(USER_PWD_3, userInfor.getPwd());
		sharedPre.setData(USER_ACCOUNT_3, userInfor.getAccount());
	}
	
	public UserInfor getUser1()
	{
		String account = sharedPre.getData(USER_ACCOUNT_1, "");
		String pwd = sharedPre.getData(USER_PWD_1, "");
		String userName = sharedPre.getData(USER_NAME_1, "");
	...
	public UserInfor getUser2()
	{
		String account = sharedPre.getData(USER_ACCOUNT_2, "");
		String pwd = sharedPre.getData(USER_PWD_2, "");
		String userName = sharedPre.getData(USER_NAME_2, "");
	...
	public UserInfor getUser3()
	{
		String account = sharedPre.getData(USER_ACCOUNT_3, "");
		String pwd = sharedPre.getData(USER_PWD_3, "");
		String userName = sharedPre.getData(USER_NAME_3, "");
	...
	public void setUserRecord(UserInfor infor)
	{
		String userName1 = sharedPre.getData(USER_NAME_1, "");
		String userName2 = sharedPre.getData(USER_NAME_2, "");
		String userName3 = sharedPre.getData(USER_NAME_3, "");
		
		if(userName1.equals(infor.getUserName()))
			setUser1(infor);
		else if(userName2.equals(infor.getUserName()))
			setUser2(infor);
		else if(userName3.equals(infor.getUserName()))
			setUser3(infor);
		else
		{
