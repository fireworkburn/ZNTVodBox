...
import com.znt.vodbox.fragment.HelpItemFragment;
...
public class HelpActivity extends FragmentActivity implements OnClickListener, OnPageChangeListener
{
	...
	*/
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		tvConfirm = (TextView)findViewById(R.id.tv_view_help_confirm);
		...
		tvConfirm.setOnClickListener(new OnClickListener() 
		{
			...
			{
				// TODO Auto-generated method stub
				ViewUtils.startActivity(HelpActivity.this, AccountActivity.class, null);
				finish();
			}
		});
